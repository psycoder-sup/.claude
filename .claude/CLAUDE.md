...
- **Prefer relative paths** — when creating documents or referencing files in agent prompts, user-facing messages, skills, or generated content, use paths relative to the project root (e.g., `docs/feature/notifications/notifications-prd.md`).
